...
export type WriteInstructionData = { discriminator: number; offset: bigint; data: ReadonlyUint8Array };

export type WriteInstructionDataArgs = { offset: number | bigint; data: ReadonlyUint8Array };
